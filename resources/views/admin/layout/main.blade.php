...
<!-- Mirrored from themesbrand.com/velzon/html/default/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 10 Jul 2024 07:17:54 GMT -->
<head>
                    ...
                    <ul class="navbar-nav" id="navbar-nav">
                        ...
                        <li class="nav-item">
                            ...
                            <div class="collapse menu-dropdown" id="sidebarDashboards">
                                <ul class="nav nav-sm flex-column">
                                    <li class="nav-item">
                                        <a href="{{ route('sanpham.create') }}" class="nav-link" data-key="t-analytics"> Thêm Sản  phẩm </a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="{{ route('sanpham.index') }}" class="nav-link" data-key="t-crm"> List Sản Phẩm </a>
                                    </li>
                                </ul>
                            </div>
                        ...
                        <li class="nav-item">
                            ...
                            <div class="collapse menu-dropdown" id="sidebarApps">
                                <ul class="nav nav-sm flex-column">
                                    <li class="nav-item">
                                        <a href="{{ route('danhmuc.create') }}" class="nav-link"> <span data-key="t-file-manager">Thêm Danh mục</span></a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="{{ route('danhmuc.index') }}" class="nav-link"> <span data-key="t-to-do">List Danh Mục</span></a>
                                    </li>
                                </ul>
                            </div>
                        </li>
                        ...
                        <li class="nav-item">
                            <a class="nav-link menu-link" href="#sidebarAuth" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="sidebarAuth">
                                <i class="ri-account-circle-line"></i> <span data-key="t-authentication">chức năng</span>
                            </a>
                            <div class="collapse menu-dropdown" id="sidebarAuth">
                                <ul class="nav nav-sm flex-column">
                                    <li class="nav-item">
                                        <a href="#sidebarSignIn" class="nav-link" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="sidebarSignIn" data-key="t-signin"> chức vụ
                                        </a>
                                        <div class="collapse menu-dropdown" id="sidebarSignIn">
                                            <ul class="nav nav-sm flex-column">
                                                <li class="nav-item">
                                                    <a href="{{ route('chucvu.create') }}" class="nav-link"> <span data-key="t-file-manager">Thêm Chức vụ </span></a>
                                                </li>
                                                <li class="nav-item">
...
<!-- Mirrored from themesbrand.com/velzon/html/default/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 10 Jul 2024 07:18:54 GMT -->
</html>
